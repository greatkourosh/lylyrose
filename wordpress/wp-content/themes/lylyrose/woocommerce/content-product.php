...
<li <?php wc_product_class( 'dk-product-card', $product ); ?>>
    <div class="dk-product-media">
        <?php if ( $percent ) : ?>
            <span class="dk-product-badge-sale"><?php echo esc_html( lylyrose_fa_num( $percent ) ); ?>٪</span>
        <?php endif; ?>
        <a class="dk-wish" href="#" title="<?php echo esc_attr__( 'افزودن به علاقه‌مندی‌ها', 'lylyrose' ); ?>" onclick="return false;">
    ...
    if ( $count > 0 ) : ?>
        <div class="dk-product-rating">
            ...
            <span>(<?php echo esc_html( lylyrose_fa_num( $count ) ); ?>)</span>
        </div>
    <?php endif; ?>
    <div class="dk-product-price dk-price-row">
        <?php if ( $percent ) : ?>
            <span class="dk-discount-tag"><?php echo esc_html( lylyrose_fa_num( $percent ) ); ?>٪</span>
        <?php endif; ?>
