...
<div class="dk-cart-page">
    <div class="dk-container">
        <div class="dk-cart-stepper" aria-hidden="true">
            <span class="dk-step"><a href="<?php echo esc_url( wc_get_cart_url() ); ?>">۱. سبد خرید</a></span>
            <span class="dk-step-sep"></span>
            <span class="dk-step is-active">۲. اطلاعات ارسال و پرداخت</span>
            <span class="dk-step-sep"></span>
            <span class="dk-step">۳. تکمیل سفارش</span>
        </div>

        <h1 class="dk-cart-title">تسویه حساب</h1>
            ...
            <div class="dk-checkout-layout">
                ...
                <aside class="dk-checkout-summary">
                    <div class="dk-cart-summary-card dk-checkout-sticky">
                        <h2 class="dk-cart-summary-title">خلاصه سفارش</h2>
