...
<main class="aroma-home">
    <section class="aroma-hero">
        <div class="aroma-container aroma-hero-grid">
            <div class="aroma-hero-copy">
                <span class="aroma-eyebrow">AROMA STORE / COLLECTION 2026</span>
                <h1>رایحه‌ای که<br><strong>امضای شماست</strong></h1>
                <p>کشف مجموعه‌ای منتخب از عطرهای ماندگار، خاص و دوست‌داشتنی برای هر لحظه از زندگی.</p>
                <div class="aroma-hero-actions">
                    <a class="aroma-button aroma-button-light" href="<?php echo esc_url( $shop_url ); ?>">مشاهده محصولات <span>←</span></a>
                    <a class="aroma-text-link" href="#aroma-categories">دسته‌بندی‌ها <span>↓</span></a>
                </div>
            </div>
            <div class="aroma-hero-art" aria-hidden="true">
                <div class="aroma-sun"></div><div class="aroma-orbit aroma-orbit-one"></div><div class="aroma-orbit aroma-orbit-two"></div>
                <div class="aroma-bottle"><span>AROMA</span><b>NO. 07</b></div>
                <div class="aroma-hero-note aroma-note-top">BERGAMOT<br><small>TOP NOTE</small></div>
                <div class="aroma-hero-note aroma-note-bottom">CEDARWOOD<br><small>BASE NOTE</small></div>
            </div>
        </div>
    </section>
    ...
    <section class="aroma-deals">
        <div class="aroma-container aroma-deals-inner"><div class="aroma-deals-copy"><span class="aroma-kicker">LIMITED TIME OFFER</span><h2>لحظه‌های<br><strong>خوش‌بو</strong></h2><p>منتخب ویژه ما با تخفیف‌های جذاب، فقط برای مدت محدود.</p><a class="aroma-button aroma-button-dark" href="<?php echo esc_url( $shop_url ); ?>">خرید با تخفیف <span>←</span></a></div><div class="aroma-deals-display"><div class="aroma-deal-disc"></div><div class="aroma-mini-bottle"><span>AROMA</span><b>ÉCLAT</b></div><div class="aroma-deal-badge">تا<br><strong>۳۰٪</strong><br>تخفیف</div></div></div>
    </section>
