...
if (!\function_exists('WPMailSMTP\\Vendor\\mb_ucfirst')) {
    /** @return string|false */
...
if (!\function_exists('WPMailSMTP\\Vendor\\mb_lcfirst')) {
    /** @return string|false */
...
if (!\function_exists('WPMailSMTP\\Vendor\\mb_trim')) {
    /** @return string|false */
...
if (!\function_exists('WPMailSMTP\\Vendor\\mb_ltrim')) {
    /** @return string|false */
...
if (!\function_exists('WPMailSMTP\\Vendor\\mb_rtrim')) {
    /** @return string|false */
