...
class ZarinPlusGateway extends BaseGateway implements BNPLFeature, InquiryFeature, RefundFeature {

	protected string $name = 'زرین پلاس';

	protected string $description = 'zarinplus.com';

	protected string $url = 'https://l.nabik.net/zarinplus';
