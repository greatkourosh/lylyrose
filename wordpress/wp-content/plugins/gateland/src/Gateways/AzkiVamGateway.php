...
class AzkiVamGateway extends BaseGateway implements BNPLFeature, InquiryFeature {

	protected string $name = 'ازکی وام';

	protected string $description = 'azkivam.com';

	protected string $url = 'https://l.nabik.net/azkivam';
