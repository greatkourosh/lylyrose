...
class YektaPayGateway extends BaseGateway implements BNPLFeature, InquiryFeature {

	protected string $name = 'یکتاپی';

	protected string $description = 'yektapay.app';

	protected string $url = 'https://l.nabik.net/yektapay';
