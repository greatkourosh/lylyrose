...
class VandaGateway extends BaseGateway implements ShaparakFeature {

	protected string $name = 'وندا پرداخت';

	protected string $description = 'vandapardakht.ir';

	protected string $url = 'https://l.nabik.net/vandapardakht';
	...
	public function options(): array {
		return [
			[
				'label'       => 'مرچنت کد',
				'key'         => 'merchant_code',
				'description' => 'مرچنت کد درگاه وندا پرداخت',
			],
		];
	}
}