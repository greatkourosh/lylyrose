...
class NoPayGateway extends BaseGateway implements BNPLFeature, InquiryFeature {

	protected string $name = 'نوپی';

	protected string $description = 'nopay.ai';

	protected string $url = 'https://l.nabik.net/nopay';
