...
class MabnaCardGateway extends BaseGateway implements ShaparakFeature {

	protected string $name = 'مبنا کارت';

	protected string $description = 'مبنا کارت آریا - mcac';

	protected string $url = 'https://l.nabik.net/mcac';
